...
<body background="admin_image\login_background.jpg">
  ...
  <form class="" action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
    ...
    <div class="container" style="margin-top:200px;">
      <div class="row justify-content-center">
          <div class="col-lg-6">
              <h1 class="mt-4 mb-3" style="color:#454242 ;">
      ...
      <div class="card" style="height:250px; background-image:url('admin_image\3d-rendering-blood-drop-red-600nw-2156240135.webp');">
          <div class="card-body">
