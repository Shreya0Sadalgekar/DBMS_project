...
<body style="color:black">
  ...
  <script>
    function validateForm() {
      ...
      var fullname = document.donor.fullname.value;
      var mobileno = document.donor.mobileno.value;
      var age = document.donor.age.value;
      var gender = document.donor.gender.value;
      var blood = document.donor.blood.value;
      var address = document.donor.address.value;

      // Check if required fields are empty
      if (fullname == "" || mobileno == "" || age == "" || gender == "" || blood == "" || address == "") {
